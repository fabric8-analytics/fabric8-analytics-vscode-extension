...
- fixes - Fixed an issue with the analysis report not displaying because of spaces in the manifest file path on Windows. See [PR#100](https://github.com/RHEcosystemAppEng/exhort-javascript-api/pull/100) for details.
## 0.9.1 (Dec 24th 2023)
