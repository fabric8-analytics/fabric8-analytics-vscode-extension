...
export namespace Apiendpoint {
  ...
  export const STACK_REPORT_URL: string =
    'http://stack-report-ui-v2-shumathu-fabric8-analytics.devtools-dev.ext.devshift.net/';
  ...
  export const THREE_SCALE_CONNECT_KEY: string =
    'ad467b765e5c8a8a5ca745a1f32b8487';
  export let API_ECOSYSTEM: string = '';
  export const STAGE_API_URL = 'https://f8a-analytics-preview-2445582058137.staging.gw.apicast.io'
}
