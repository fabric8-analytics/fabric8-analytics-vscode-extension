...
export class Authextension {
    ...
    static setContextData(context_f8_access_routes, context_f8_3scale_user_key) {
    ...
    static authorize_f8_analytics(context, cb) {
        ...
        if(context_f8_access_routes && context_f8_3scale_user_key){
            this.setContextData(context_f8_access_routes, context_f8_3scale_user_key);
            cb(true);
        } else {
            this.get_3scale_routes(context, cb);
        }
    };

    static get_3scale_routes (context, cb) {
        let options = {};
