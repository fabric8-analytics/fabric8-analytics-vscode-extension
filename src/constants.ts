...
export const reportOpenedNotificationPopup = 'Notification pop-up - Open report Clicked'
export const notificationPopupDismissed = 'Notification pop-up - Dismissed'